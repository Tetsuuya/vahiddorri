  ...
  return (
    <section className="w-full bg-[#111111]/90 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-md shadow-2xl p-6 sm:p-10 mb-16">
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
        {/* Album Artwork with Luxury Glow */}
        <div className="flex flex-col items-center flex-shrink-0">
          <div className="relative w-64 sm:w-72 aspect-square rounded-lg overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.8)] border border-[#d4af37]/40 group">
            <Image
          ...
          <span className="mt-4 text-xs font-bold uppercase tracking-[0.25em] text-[#d4af37] text-center">
        ...
        <div className="flex-1 w-full flex flex-col justify-between">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-zinc-800/80 pb-4 mb-4">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="px-3 py-1.5 bg-zinc-900 hover:bg-[#d4af37] hover:text-black text-zinc-300 text-[10.5px] font-semibold uppercase tracking-wider rounded border border-zinc-700 transition-colors"
                >
                  YouTube
                </a>
              </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            {FEATURED_ALBUM.tracks.map((t) => {
              const isCurrent = activeTrack === t.number;
              return (
                <div
                  key={t.number}
                  onClick={() => toggleTrack(t.number)}
                  className={`flex items-center justify-between p-3 rounded-lg border transition-all duration-200 cursor-pointer ${
                    isCurrent
                      ? "bg-[#d4af37]/10 border-[#d4af37]/50 text-white shadow-[0_0_15px_rgba(212,175,55,0.1)]"
